...
def create_mvp_visualizations(results_df, all_scores, corpus_mean, use_normalization):
    ...
    plt.tight_layout()
    fig1.savefig('mvp_article_sentiment.png', dpi=300, bbox_inches='tight')
    print("✓ Saved: mvp_article_sentiment.png")
    ...
    plt.tight_layout()
    fig2.savefig('mvp_word_distribution.png', dpi=300, bbox_inches='tight')
    print("✓ Saved: mvp_word_distribution.png")
...
def main():
    ...
    # Export table
    results_df.to_csv('mvp_results_table.csv', index=False)
    print("💾 Saved: mvp_results_table.csv\n")
